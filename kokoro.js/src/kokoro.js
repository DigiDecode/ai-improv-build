...
import { pipeline, StyleTextToSpeech2Model, AutoTokenizer, Tensor, RawAudio } from "./transformers-3.4.0.js";
...
export class KokoroTTS {
   ...
   * @param {import('./transformers-3.4.0.js').StyleTextToSpeech2Model} model The model
   * @param {import('./transformers-3.4.0.js').PreTrainedTokenizer} tokenizer The tokenizer
   */
   ...
   * @param {import("./transformers-3.4.0.js").ProgressCallback} [options.progress_callback=null] A callback function that is called with progress information.
